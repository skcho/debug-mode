...
(* OASIS_START *)
(* DO NOT EDIT (digest: ee028a3e656794a157ac6246a57238e5) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          authors = ["skcho"];
          homepage = None;
          synopsis = "Interactive CLI debug mode.";
          description = None;
          categories = [];
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "8\030S,\n\150\149\200\159\2320\198!Z\182\164";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
